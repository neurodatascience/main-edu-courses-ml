...
- 30 different animals made prognostics about match results in the 2018 World Cup
#+ATTR_LATEX: :height .65 \textheight
[[file:figures/generated/select_evaluate/select_evaluate_1.pdf]]
*** Training error is a biased estimator of the risk
- 30 different animals made prognostics about match results in the 2018 world cup
- We *selected the best predictor* (highest average accuracy)
#+ATTR_LATEX: :height .65 \textheight
...
*** Training error is a biased estimator of the risk
The selected animal is more likely to perform *worse* on average than in 2018.
#+ATTR_LATEX: :height .65 \textheight
